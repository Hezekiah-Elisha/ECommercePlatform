<x-layout>
    ...
    <div class="mt-6 space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
            <div class="bg-white p-4 rounded-lg hover:shadow-lg transition duration-300 hover:cursor-pointer" onclick="window.location.href='{{ route('product.show', ['id' => 1]) }}'">
                ...
                <button
                    class="flex flex-row justify-between align-middle items-center bg-primary text-white px-4 py-2 rounded mt-2 hover:bg-primary-dark transition duration-300 gap-2">
                    <x-lucide-shopping-cart class="size-4" />
                    Add to Cart
                </button>
            </div>
            <div class="bg-white p-4 rounded-lg hover:shadow-lg transition duration-300 hover:cursor-pointer" onclick="window.location.href='{{ route('product.show', ['id' => 2]) }}'">
            ...
            <div class="bg-white p-4 rounded-lg hover:shadow-lg transition duration-300 hover:cursor-pointer" onclick="window.location.href='{{ route('product.show', ['id' => 3]) }}'">
            ...
            <div class="bg-white p-4 rounded-lg hover:shadow-lg transition duration-300 hover:cursor-pointer" onclick="window.location.href='{{ route('product.show', ['id' => 4]) }}'">
